...
class py_nvpfm:
    ...
    class ev_type:
        ...
        DepthAlignRGB: ClassVar[py_nvpfm.ev_type] = ...
        DepthAlignRGBPseudo: ClassVar[py_nvpfm.ev_type] = ...
    ...
    def init_and_start(self, arg0: str, arg1: typing.SupportsInt) -> int: ...
    def read_cam_param(self) -> list[s_nvpfm_camera_param]: ...
    def read_data(self) -> list[event_data]: ...
    def set_event_enabled(self, arg0, arg1: bool) -> None: ...
    def stop(self) -> None: ...

class s_nvpfm_camera_param:
    def __init__(self) -> None: ...
    def _pybind11_conduit_v1_(self, *args, **kwargs) -> Any: ...
    @property
    def color_focus(self) -> list[float]: ...
    @property
    def color_photocenter(self) -> list[float]: ...
    @property
    def irheight(self) -> int: ...
    @property
    def irwidth(self) -> int: ...
    @property
    def left2color_matrix(self) -> list[float]: ...
    @property
    def left2right_matrix(self) -> list[float]: ...
    @property
    def left_ir_focus(self) -> list[float]: ...
    @property
    def left_ir_photocenter(self) -> list[float]: ...
    @property
    def result(self) -> int: ...
    @property
    def rgbheight(self) -> int: ...
    @property
    def rgbwidth(self) -> int: ...
    @property
    def right_ir_focus(self) -> list[float]: ...
    @property
    def right_ir_photocenter(self) -> list[float]: ...
